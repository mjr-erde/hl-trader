...
echo "    npm run server        # backend on :3000"
echo ""
echo "  Run the trading agent (paper mode — no real money):"
echo "    npx tsx hyperliquid-trader/src/agent.ts --dry-run --interval 3 --verbose"
echo ""
echo "  Run live (real money — read CLAUDE.md first):"
echo "    npx tsx hyperliquid-trader/src/agent.ts --interval 3 --verbose"
echo ""
