...
if command -v claude &>/dev/null; then
  ...
  echo ""
  sleep 1
  exec claude "Welcome to hl-trader! Setup is complete. Please help me configure and launch a new trading agent. Start by running the trading wizard to set my risk profile: npx tsx hyperliquid-trader/src/agent.ts --help-me"
else
