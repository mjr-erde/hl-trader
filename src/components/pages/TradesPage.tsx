          ...
          {selectedTrade ? (
            <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "0.25rem" }}>
                ...
                <ModeBadge mode={selectedTrade.mode} />
              </div>

              {[
                ["Agent", selectedTrade.session_id?.slice(-30) ?? "—"],
                ...
                return (
                  ...
                  >
                    ...
                    <td style={{ ...CELL, maxWidth: "160px", overflow: "hidden", textOverflow: "ellipsis" }}>
                      <span title={t.session_id}>{t.session_id?.slice(-25) ?? "—"}</span>
                    </td>
                    ...
                    <td style={CELL}><ModeBadge mode={t.mode} /></td>
                  </tr>
                );
              })}
