    ...
    <PageLayout>
      ...
      {positions.length === 0 && closed.length === 0 && (
        <div style={{
          ...
          <div style={{ fontSize: "0.95rem", color: "#94a3b8", marginBottom: "0.25rem" }}>No trades yet</div>
          <div style={{ fontSize: "0.85rem" }}>
            Trades will appear here as the agent opens positions, or use Buy/Sell above to place a manual paper trade.
          </div>
        </div>
      )}
